(custom-set-variables
 ...
 '(package-selected-packages
   '(org-roam org-download org-timeblock typewriter-roll-mode ros tree-sitter tree-sitter-langs tsc emacs-gc-stats academic-phrases sly magit company lsp-mode yasnippet sqlite3 forge chatgpt-shell helm-catkin 2048-game dap-mode helm-lsp consult-lsp dired-imenu lsp-focus lsp-ivy which-key consult-flycheck flycheck-clang-analyzer magit-diff-flycheck magit-filenotify magit-find-file magit-lfs magit-todos makefile-executor sideline-flycheck sideline-lsp lsp-ui consult-eglot flycheck-yamllint flymake-yaml flymake-yamllint yaml-imenu vs-dark-theme vscode-icon posframe cmake-font-lock cmake-ide cmake-project markdown-preview-mode csv-mode json-mode gnu-elpa-keyring-update doom-themes use-package helm-slime helm-sly gnu-elpa bash-completion sync-recentf flymake-shellcheck git-gutter flycheck-clang-tidy clang-format+ projectile common-lisp-snippets flymd eglot dockerfile-mode cmake-mode find-file-in-project org-journal noaa nov jedi elpy indent-tools yaml-mode multiple-cursors hydra lsp-treemacs flycheck avy slime-repl-ansi-color xquery-mode xquery-tool hideshow-org outshine ggtags restart-emacs magit-svn nyan-mode zone-nyan paredit slime-company))
